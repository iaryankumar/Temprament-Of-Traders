...
const Footer = () => {
    return (
        <>
            <footer className="bg-gray-50 px-4 sm:px-6 pt-12 pb-6  font-nav">
                <div className="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    <div className="space-y-2">
                        ...
                        <p className='text-[14.5px] text-gray-600'>Tech Solutions Pvt. Ltd., 3rd Floor, A-15, Vibhuti Khand, Gomti Nagar, Lucknow, Uttar Pradesh - 226010, India</p>
                    </div>
                    <div className="space-y-2">
                        <h6 className="text-[16px] font-semibold">Handler</h6>
                        <p className='text-[14.5px] text-gray-600'>Vivek Kushwaha</p>
                    </div>
                    <div className="space-y-2">
                        <h6 className="text-[16px] font-semibold">Pages</h6>
                    ...
                    <div className="space-y-2">
                        <h6 className="text-[14px] font-semibold">SOCIAL MEDIA</h6>
                ...
                <div className="max-w-screen-xl mx-auto text-center">
                    <p className="text-gray-400 text-[13px]">
                        Made With ❤️ by <a href="" className='text-blue-700 underline ml-1'>Aryan</a>
                        {/* TOT Copyright © 2024. All rights reserved. */}
                    </p>
                </div>
            </footer>
        </>
