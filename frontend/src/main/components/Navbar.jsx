...
const Navbar = ({ hero, about, playlist, reviews }) => {
  // console.log(val)
      ...
      <nav className='h-[78px] w-full bg-primary2 text-primary flex items-center justify-between md:px-12 px-8 sticky top-0 z-50'>
        ...
        <div className='h-full flex items-center'>
          <ul className='md:flex hidden gap-3 h-full items-center font-rubik text-[14px]'>
            ...
            <li className='cursor-pointer hover:text-blue-600 hover:underline'><button className='bg-blue-700 px-3 py-2 text-white rounded text-[14px] ml-5 outline-none hover:bg-blue-600 cursor-pointer transition-all ease-initial '>Get Mentorship</button></li>
          </ul>
